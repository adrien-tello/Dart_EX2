# Dart_EX2
About Given a list of strings, create a Map where keys are the strings and values are their lengths. Then print only entries where the length is greater than 4.
...
#Objective
Given a list of strings, create a Map where keys are the strings and values are their lengths. Then print only entries where the length is greater than 4.

#Concepts Demonstrated
associateWith
Transforms a List into a Map. Each element becomes a key, and the lambda result becomes its value.
